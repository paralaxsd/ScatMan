...
User preferences for this commit (may be empty): $ARGUMENTS
...
3. Summarize all changes as a concise bullet list grouped by area (core / cli / mcp / build).
4. Propose a conventional commit message (type: short summary, optional body).
   - If the user passed preferences (e.g. a specific message, which files to include, or other hints), apply them here.
